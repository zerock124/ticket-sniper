// ============================================================
// inline-content.js — Inline 訂位助手 內容腳本（Tixcraft 風格重構版）
// ============================================================
// 功能：在 Inline 訂位網站上執行自動訂位流程
//
// 主要流程：
// 1. BOOKING 頁：選擇人數 → 依三段式優先順序選擇日期時間 → 點擊 submit
// 2. FORM 頁：填寫聯絡資訊 → 點擊 submit
// 3. SUCCESS 頁：確認訂位成功，檢查成功訊息或行事曆彈窗
//
// 三段式日期時間優先順序：
// 1. Exact（精確）：指定日期 + 指定時間的組合
// 2. Range（範圍）：指定日期 + 時間範圍
// 3. Any（任意）：指定日期 + 任何時間
//
// 特殊功能：
// - 支援訂位頁面狀態偵測和自動跳轉
