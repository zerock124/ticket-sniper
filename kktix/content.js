...
if (window.__kktixLoaded) {
        ...
        while (attempts < maxAttempts) {
            ...
            if (el) {
                for (let i = 0; i < clickCount; i++) {
                    ...
                    // 檢查當前數量是否為預期值（如果有的話），如果已達預期值則不必繼續點擊
    ...
    async function step1() {
        console.log(CONFIG.choose_area);
